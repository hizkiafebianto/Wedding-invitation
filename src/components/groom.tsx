    ...
    const flowers = [
        {
            ...
            height: 90,
            delay: "0s",
            className: "pointer-events-none absolute animate-sway right-28 top-[250px] z-20 lg:right-36",
        },
        {
            src: "/png/12.png",
            alt: "Flower 12",
            ...
            height: 200,
            delay: "0.4s",
            className: "pointer-events-none absolute right-16 top-[300px] z-30 lg:right-24 lg:rotate-0",
        },
        {
            src: "/png/6.png",
            alt: "Flower 6",
            ...
            height: 50,
            delay: "0.8s",
            className: "pointer-events-none absolute animate-sway right-20 top-[250px] z-20 lg:right-28 lg:top-[290px]",
        },
        {
            src: "/png/6.png",
            alt: "Flower 6",
            ...
            height: 50,
            delay: "1.2s",
            className: "pointer-events-none absolute animate-sway right-48 top-[260px] z-20 lg:right-[240px] lg:top-[280px]",
        },
        {
            src: "/png/10.png",
            alt: "Flower 10",
        ...
        },
        {
            ...
            height: 200,
            delay: "0s",
            className: "pointer-events-none absolute -left-28 top-28 z-20 lg:top-28 animate-sway lg:-left-4",
        },
        {
            src: "/png/8.png",
            alt: "Flower 8",
            ...
            height: 130,
            delay: "0.4s",
            className: "pointer-events-none absolute -left-12 top-52 z-10 lg:top-56 animate-sway lg:-left-4",
        },
        {
            src: "/png/9.png",
            alt: "Flower 9",
            ...
            height: 110,
            delay: "0.8s",
            className: "pointer-events-none absolute -left-40 top-0 z-10 lg:top-0 animate-sway lg:-left-28 rotate-35",
        },
        {
            src: "/png/9.png",
            alt: "Flower 9",
            ...
            height: 120,
            delay: "1.2s",
            className: "pointer-events-none absolute -left-12 -top-24 animate-sway z-0 lg:-top-28 lg:-left-3",
        },
        {
            src: "/png/4.png",
            alt: "Flower 4",
