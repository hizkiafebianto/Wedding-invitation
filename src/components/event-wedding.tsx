    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full px-4">
        <motion.div
          ...
          className="text-center text-white space-y-3 max-w-xl"
        >
          ...
          <h2 className={`${greatVibes.className} text-6xl font-bold tracking-widest drop-shadow-md`}>
            Wedding Reception
          </h2>
          ...
          <p className="text-base mx-auto max-w-sm">Jl. Bahagia No.153, Panjunan, Kec. Lemahwungkuk, Kota Cirebon, Jawa Barat 45112</p>
